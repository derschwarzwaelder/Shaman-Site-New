...
<div class="hero-image sy"><div class="hero-txtCont"><div class="hero-txt"><h2><?= $page->title_hero()->html() ?></h2><p class="hero-subtxt"><?= $page->beschreibung_hero()->kirbytext() ?></p></div>

Ich bin die Aufstellung
